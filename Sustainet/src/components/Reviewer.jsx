...
const API_URL = "http://197.248.122.31/sustainet_voucher_api/public/api/voucher-approvals";
              ...
              {filteredVouchers.length === 0 ? (
                ...
                filteredVouchers.map((voucher, index) => (
                  <tr key={voucher.id ? voucher.id : index}>
                    ...
                    <td>{voucher.supplier_account || "N/A"}</td>
        ...
        {selectedVoucher && (
          <div className="modal-overlay">
            <div className="modal-content">
              ...
              <p>
                <strong>Supplier Account:</strong> {selectedVoucher.supplier_account || "N/A"}
              </p>
              <p>
              ...
              <p>
                ...
                {selectedVoucher.invoice ? (
                  <a
                    href={`${INVOICE_BASE_URL}${selectedVoucher.invoice}`}
                    target="_blank"
